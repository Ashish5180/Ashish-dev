    ...
    return (
      ...
      >
        ...
        <style jsx>{`
          ...
          .fx-progress-fill { position: absolute; inset: 0 auto 0 0; width: 0%; background: var(--fx-text); height: 100%; transition: width 0.7s cubic-bezier(0.16, 1, 0.3, 1); }
          ...
          @media (max-width: 900px) {
            .fx-header { padding-top: 10vh; font-size: clamp(2rem, 12vw, 5rem); }
            .fx-content {
            ...
            .fx-footer { padding-bottom: 15vh; }
            .fx-footer-title { font-size: calc(2.2rem); }
            .fx-progress { width: 140px; }
          }
        `}</style>
      </div>
    );
